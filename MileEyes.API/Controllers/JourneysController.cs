            ...
            try
            {
                ...
                if (j.Accepted)
                {
                    ...
                    if (calc)
                    {
                        ...
                        costs = j.CalculateCost(driverInfo.FirstOrDefault().CurrentMileage);
                        j.Cost = costs.Cost;
                        j.OverDistance = costs.OverDistance;
                        j.UnderDistance = costs.UnderDistance;
                    }
                }
...
//                }
        ...
        public async Task<HttpResponseMessage> GetDownloadJourneys(string userId)
        {
            ...
            var fileString = currentUser.FirstName + " " + currentUser.LastName + "'s Personal Journeys: \n\n" + 
